...
public class ConditionalOperator {
	...
	public static void main(String[] args) {
		...
		//sa fac ternarul 
		String result3 = (num1 > 0 && num2 > 0) ? "Ambele numere sunt pozitive" : "Cel putin un numar din cele doua este negativ";
		...
		result = (num1 > num2) ? "Number num1 is the greatest" : (num1 < num2) ?
				"Number num2 is the greatest" :
					"Numbers are equals"; 
